...
export const ABOUT_TEXT = `I am Sunil Belbase, a passionate mechanical engineer driven by a commitment to innovation and sustainable solutions. Growing up in Kapilvastu District, Nepal, I developed a fascination with machinery and engineering principles from a young age. With a solid foundation in thermodynamics, fluid mechanics, and system design, I have worked on diverse projects ranging from aerodynamics to clean cooking technologies.

As the Lead Engineer at Project Antarikshya Private Limited, I oversee design and simulation analysis, collaborating across IT and engineering disciplines to deliver cutting-edge solutions. Additionally, I am dedicated to empowering local communities through my startup, Gauko, which promotes organic products. I continually strive to explore new frontiers in engineering, aiming to create impactful and lasting change.`;
